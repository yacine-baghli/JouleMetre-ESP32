...
// // #define os_Tension  1	    // offset in OutData : position de la val 
// // #define os_Courant  9
// // #define os_Secondes 17
...
// // fonction appelée tous les Tsamp_us
// void mesure(){
...
//   float Vmes = (12.0/15625.0)*analogRead(entreeAnalogique1) + 0.1734;
//   float Imes = (12.0/15625.0)*analogRead(entreeAnalogique2) + 0.1734;
//   float Ival = Vmes/R;

//   Serial.println("Vmes = "+ String(Vmes)+" V");
//   Serial.println("Imes = "+ String(Imes)+" V");
//   Serial.println("Ival = "+ String(Ival)+" A");
//   Serial.println("Secondes = "+ String(Secondes));

//   // Send timer value over serial
//   Serial.print("$V");
//   Serial.print(Vmes, 3);
//   Serial.print(" I");
//   Serial.print(Imes, 3);
